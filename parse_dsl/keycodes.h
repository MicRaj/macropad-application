...
// Keycodes for the standard US keyboard layout (HID Usage IDs)
#define KEY_A          0x04
#define KEY_B          0x05
#define KEY_C          0x06
#define KEY_D          0x07
...
// Modifiers (used in the HID descriptor)
...
// Special keys (Media and other functions)
#define KEY_MEDIA_PLAY_PAUSE     0xCD
#define KEY_MEDIA_STOP           0xCE
#define KEY_MEDIA_NEXT_TRACK     0xCF
#define KEY_MEDIA_PREV_TRACK     0xD0
